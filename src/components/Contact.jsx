...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_y6qtsg4', 'template_i1qalf3', form.current, 'MHQ7PGZg1iE-lmFyW')
            .then((result) => {
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <form ref={form} onSubmit={sendEmail} className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="user_name" className="label reveal-up">Nombre</label>
                            <input 
                                type="text" 
                                name="user_name" 
                                id="user_name" 
                        ...
                        <div className="mb-4">
                            <label htmlFor="user_email" className="label reveal-up">Email</label>
                            <input 
                                type="email" 
                                name="user_email" 
                                id="user_email" 
